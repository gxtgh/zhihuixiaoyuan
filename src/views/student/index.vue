      ...
      <el-col :span="12" class="left-container">
        ...
        <el-card class="box-card">
          ...
          <el-table
            ...
            style="width: 100%"
          >
            <el-table-column prop="title" label="事务名称" />
            ...
            <el-table-column prop="status" label="状态" width="150" align="center">
              <template slot-scope="scope">
                <i class="el-icon-time" :class="statusColor" />
            ...
            <el-table-column label="操作" width="100" align="center">
              <template slot-scope="scope">
                <i :class="scope.row.collection?'el-icon-star-on color-red':'el-icon-star-off'" class="font-size-25" @click="changeCollection(scope.row)" />
              </template>
            </el-table-column>
          </el-table>
        </el-card>
